...
mcp = FastMCP("telegram", host=(os.getenv("FASTMCP_HOST") if os.getenv("FASTMCP_HOST") is not None else "0.0.0.0"), port=int(os.getenv("FASTMCP_PORT") if os.getenv("FASTMCP_PORT") is not None else "8000"))
